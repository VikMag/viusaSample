					 ...
					 <div class="main_menu">
						<nav id="dropdown">
							<ul class="sf-menu clearfix">								
								...
								<li class="current"><a href="contact.php"><span>Contacto</span></a></li>							
							</ul>
						</nav>	
                       </div>						
				 <!-- end navigation -->
	...
	<div class="container content_wrapper_section">  
      ...
      <div class="row">
               <div class="span12">        	
                    ...
                    <h2 class="contact_text">Te invitamos a ponerte en contacto con nosotros</h2>               					
		       </div>
				<div class="clear"></div>
				<div class="contact_inner span12">
					<!--<div class="one_fourth contact_inner_text">
						...
						<div class="contact_text_info">
							<span>Adress :</span> Street 177, New York
						</div>
					</div>-->
					<div class="one_fourth contact_inner_text">
						<div class="contact_icon_holder">
						...
						<div class="contact_text_info">
							<span>Teléfono :</span> 01(800)467-21-72
						</div>
					</div>
					<div class="one_fourth contact_inner_text">
						<div class="contact_icon_holder">
						...
						<div class="contact_text_info">
							<span>Teléfono :</span> +52(477)211-19-50
						</div>
					</div>
					<!--<div class="one_fourth contact_inner_text">
						<div class="contact_icon_holder">
					...
					<div class="one_fourth lastcolumn contact_inner_text">
						...
						<div class="contact_text_info">
							<span>Mail :</span> contacto@viusa.com.mx
						</div>
					</div>
					<div class="clear"></div>
				</div>
			<div class="span12">  	
				<form class="contact_form contact_form_h" action="gracias.php" style="margin-bottom: 10px;" method="post"	>
				
					<div class="input_holder">
						<input class="field-name" type="text" placeholder="Nombre (requerido)" name="nombre" required>
					</div>
					<div class="input_holder">
						<input class="email_field" type="email" placeholder="Email (requerido)" name="email" required>
					</div>
					<div class="input_holder">
						<input class="subject_field" type="text" placeholder="Asunto" name="asunto">
					</div>
					<div class="textarea_holder">
						<textarea class="comment_field" placeholder="Mensaje" name="mensaje"></textarea>
					</div>
                    <?php
          require_once('recaptchalib.php');
          $publickey = "6LfKGvYSAAAAAAygahSqFulPom2GK3hGPUHZhD3m"; // you got this from the signup page
...
<script type="text/javascript">
      $(function(){
        $('#googlemap').gmap3({
          marker:{
            address: "León Guanajuato"  // Your Adress Here
          },
          map:{
            options:{
			  zoom: 16,
