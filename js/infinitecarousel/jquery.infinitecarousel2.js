	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			for(i=1;i<=o.inView;i++)
			{
				...
				$('#textholder'+randID+'_'+i).height(imgHeight*o.textholderHeight).css({'backgroundColor':'#000000','opacity':'0.8'});
